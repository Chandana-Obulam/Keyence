...
(2) File and folder configuration

  This software has the following contents:

  ReadMe.txt            - This file.
  LkIF2.DLL             - DLL program file.
  LkIF2.H               - A header file for using the program from VC.
  LkIF2.lib             - A lib file used to link LkIF2.
  CmnLib.dll            - Required to operate DLL.
  KeyUsbDrv.dll         - Required to operate DLL.
  HelpFiles folder      - Reference for DLL.
                          Each file describes a single function. You can browse all files by opening ReadMe.htm.
  Samples folder        - Contains sample codes used to invoke the program from VC++.Use these codes if necessary.


(3) The USB driver for LK-Navigator 2 must be installed.


(4) This DLL includes the DLL interfaces for the LK-G3000 Series, 
  however, this DLL is designed for the K-G5000 Series and the operation with the LK-G3000 Series is not guaranteed.
